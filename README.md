...
pxtone Plug's code is licensed under the [GNU GPLv3 License](COPYING) (as required by the Steinberg's licensing agreement [(link)](https://steinbergmedia.github.io/vst3_dev_portal/pages/FAQ/Licensing.html#q-i-would-like-to-share-the-source-code-of-my-vst-3-plug-inhost-on-github-or-other-such-platform))

This repo includes code ported from pxtone (and uses [rust-pxtone-sys](PieKing1215/rust-pxtone-sys) which contains pxtone source code):<br>
