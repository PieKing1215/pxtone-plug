...
Automated dev builds can be downloaded in [here](https://github.com/PieKing1215/pxtone-plug/actions/workflows/autobuild.yml?query=branch%3Amain) after signing in to GitHub.<br/>
...
pxtone Plug's code is licensed under the [GNU GPLv3 License](COPYING) (as required by Steinberg's old terms)

This repo includes code ported from pxtone and ptCollage ([zlib License](PTCOLLAGE_LICENSE))<br/>
(and uses [rust-pxtone-sys](https://github.com/PieKing1215/rust-pxtone-sys) which contains pxtone source code):<br/>
