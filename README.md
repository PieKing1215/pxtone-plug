...
This repo includes code ported from pxtone and ptCollage ([zlib License](https://github.com/ewancg/ptCollage/blob/4a2889148215fa37bbe6ed0544304e6120fac6be/LICENSE)) (and uses [rust-pxtone-sys](https://github.com/PieKing1215/rust-pxtone-sys) which contains pxtone source code):<br>
